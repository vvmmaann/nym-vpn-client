...
- Fix environment switcher failing to update gateway cache, topology cache, and API clients when switching between environments (https://github.com/nymtech/nym-vpn-client/pull/4464)
